...
SBX.Version = function() {}

SBX.Version.prototype.constructor = SBX.Version;

SBX.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
SBX.Version.prototype.getVersionHash = function(callback) {
...
SBX.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
